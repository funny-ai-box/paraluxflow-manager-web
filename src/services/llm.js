...
export async function fetchLlmProviderDetail(provider_id) {
  return request('/api/v1/llm/provider/detail', {
    method: 'GET',
    params: { provider_id }
  });
}
...
export async function fetchLlmProviderModels(provider_id) {
  return request('/api/v1/llm/provider/models', {
    method: 'GET',
    params: { provider_id }
  });
}
...
export async function updateLlmProviderConfig(config) {
  return request('/api/v1/llm/provider/update_config', {
    method: 'POST',
    data: config
  });
}
...
export async function testLlmProvider(data) {
  return request('/api/v1/llm/provider/test', {
    method: 'POST',
    data
  });
}